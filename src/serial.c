  ...
  switch(cmdMSP) {
   ...
   case MSP_STATUS:
     ...
     serialize32(f.ACC_MODE<<BOXACC|f.BARO_MODE<<BOXBARO|f.MAG_MODE<<BOXMAG|f.ARMED<<BOXARM|
                 ...
                 f.PASSTHRU_MODE<<BOXPASSTHRU|rcOptions[BOXBEEPERON]<<BOXBEEPERON|rcOptions[BOXLEDMAX]<<BOXLEDMAX|
                 rcOptions[BOXLLIGHTS]<<BOXLLIGHTS|rcOptions[BOXHEADADJ]<<BOXHEADADJ|f.FLOW_HOLD_MODE<<BOXFLOWHOLD);
     break;
   case MSP_RAW_IMU:
     headSerialReply(18);
